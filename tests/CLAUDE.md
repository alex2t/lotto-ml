...
- `npm --prefix frontend test` - 358 vitest tests over the data layer, the scoring, the chat panel and the wording
  source lint, against the trimmed fixtures in `frontend/test/fixtures/`;
- `npm --prefix frontend run test:e2e` - 100 Playwright tests, desktop and mobile, over the rendered
