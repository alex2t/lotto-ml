...
- `npm --prefix frontend test` - 318 vitest tests over the data layer, the scoring, the chat panel and the wording
  source lint, against the trimmed fixtures in `frontend/test/fixtures/`;
- `npm --prefix frontend run test:e2e` - 80 Playwright tests, desktop and mobile, over the rendered
