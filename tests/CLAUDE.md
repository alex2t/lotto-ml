...
**Only nine files in this folder are real tests. Do not run `pytest tests/` bare** - the other
...
## The nine real tests (79 tests, ~15s)
...
python -m pytest tests/test_walk_forward_parity.py tests/test_selection_invariants.py \
                 ...
                 tests/test_scraper_sources.py -q
```
...
| `test_selection_invariants.py` | generated lines satisfy the playable-ticket constraints |
...
alone unless you are converting one into a real test - in which case add it to the nine-file list
