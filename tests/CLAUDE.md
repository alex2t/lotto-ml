...
- `npm --prefix frontend test` - 167 vitest tests over the data layer, the scoring and the wording
  source lint, against the trimmed fixtures in `frontend/test/fixtures/`;
- `npm --prefix frontend run test:e2e` - 70 Playwright tests, desktop and mobile, over the rendered
