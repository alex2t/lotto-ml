...
# For lottery prediction: Use ALL available data to maximize learning from history
VALIDATION_SPLIT_RATIO = 1.0  # 100% train - use all available data for predictions
