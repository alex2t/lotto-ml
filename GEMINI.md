...
# Execute all 16 test files (158 tests, ~30s) - pytest.ini limits pytest to tests/
...
| **`tests/`** | 16 test files, nothing else (see Section 7) | Guards parity, model capacity, invariants, filter rules, scraper integrity, and wheel coverage. |
