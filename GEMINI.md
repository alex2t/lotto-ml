...
# Execute all 14 test files (139 tests, ~30s) - pytest.ini limits pytest to tests/
...
| **`tests/`** | 14 test files, nothing else (see Section 7) | Guards parity, model capacity, invariants, filter rules, scraper integrity, and wheel coverage. |
