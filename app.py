...
from view.pages import trigger_analysis, draw_history, statistics, freshness_analysis, prediction_validator, number_insights, pattern_comparison, post_draw_analysis
...
PAGES = {
    ...
    "📊 Post Draw Analysis": post_draw_analysis
}
