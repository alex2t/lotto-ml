...
# Execute all 17 test files (162 tests, ~30s) - pytest.ini limits pytest to tests/
...
| **`tests/`** | 17 test files, nothing else (see Section 7) | Guards parity, model capacity, invariants, filter rules, scraper integrity, and wheel coverage. |
