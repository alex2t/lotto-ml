...
VERSION: 3.13 (Phase 1 Complete - Advanced Pattern Features)
...
- FIXED: LONG_TERM_PATTERN_WEIGHTS now uses corrected recency data
  ...
  * REMOVED: Redundant lt_hot/medium/cold_weight features (perfect multicollinearity)
  * KEEPING: lt_category_alignment, lt_recency_weight (5-18% feature importance)
- NEW: ADVANCED_PATTERN_FEATURES with volatility and trend analysis
  * appearance_volatility, gap_consistency_score, max_gap_ratio
  * appearance_trend, appearance_acceleration, recent_vs_baseline
  * Generated by advanced_pattern_analyzer.py
- ALL MODELS updated to use constants instead of explicit feature lists
"""
