    ...
    def extract_features_at_draw(self, t: int) -> Dict[int, Dict[str, Any]]:
        ...
        for num in range(1, MAX_NUMBER + 1):
            ...
            rec = {
                ...
                'series_total': static_feat.get('series_total', 0),
                'series_recent': static_feat.get('series_recent', 0),
                ...
                'range_spread_json': static_feat.get('range_spread_json', 0.5),
                'odd_even_json': static_feat.get('odd_even_json', 0.5),
                'sum_contribution_json': static_feat.get('sum_contribution_json', 0.5),
                'window_saturation_penalty': static_feat.get('window_saturation_penalty', 0.0),
                ...
                'lt_category_alignment': static_feat.get('lt_category_alignment', 0.5),
                'lt_recency_weight': static_feat.get('lt_recency_weight', 0.5),
                'category': cat,
