...
suites in `frontend/` - `npm --prefix frontend test` (340 vitest) and `npm --prefix frontend run
test:e2e` (94 Playwright, desktop and mobile); `pytest` does not run them. `pytest.ini` points pytest there, so
