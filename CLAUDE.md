...
| `tests/CLAUDE.md` | the twenty test files and what each one guards |
...
`tests/` holds only real tests: twenty files, 183 tests, ~30s. `pytest.ini` points pytest there, so
