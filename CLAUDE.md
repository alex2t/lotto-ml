...
| `tests/CLAUDE.md` | the fifteen test files and what each one guards |
...
`tests/` holds only real tests: fifteen files, 152 tests, ~30s. `pytest.ini` points pytest there, so
