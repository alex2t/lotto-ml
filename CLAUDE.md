...
| `tests/CLAUDE.md` | the fourteen test files and what each one guards |
...
`tests/` holds only real tests: fourteen files, 139 tests, ~30s. `pytest.ini` points pytest there, so
