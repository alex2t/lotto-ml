...
| `tests/CLAUDE.md` | the sixteen test files and what each one guards |
...
`tests/` holds only real tests: sixteen files, 158 tests, ~30s. `pytest.ini` points pytest there, so
