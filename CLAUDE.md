...
suites in `frontend/` - `npm --prefix frontend test` (332 vitest) and `npm --prefix frontend run
test:e2e` (90 Playwright, desktop and mobile); `pytest` does not run them. `pytest.ini` points pytest there, so
